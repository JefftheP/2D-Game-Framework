...
namespace Engine
{
     ...
     SDL_Texture *MakeTextureFromText(std::string text, TTF_Font *font, SDL_Color *color = NULL, EngineRenderer *renderer = NULL);

     void Stop();
     Engine::EngineRenderer *GetWindowRenderer();
} // namespace Engine